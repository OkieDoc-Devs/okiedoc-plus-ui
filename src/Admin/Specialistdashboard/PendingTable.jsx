        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <span style={{ fontSize: '16px', color: '#2c3e50' }}>
                {viewModalApp.details?.specializations?.join(', ') || 'N/A'}
              </span>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <span style={{ fontSize: '16px', color: '#2c3e50' }}>
                {viewModalApp.details?.subspecializations?.join(', ') || 'N/A'}
              </span>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              >
                ...
                >
                  {viewModalApp.details?.prcId?.number || 'N/A'}
                </span>
                {viewModalApp.details?.prcId?.imageUrl && (
                  <button
                    style={viewButtonStyle}
                    onClick={() =>
                      setImageViewUrl(viewModalApp.details.prcId.imageUrl)
                    }
                  >
                    View ID
                  </button>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              >
                ...
                >
                  {viewModalApp.details?.s2?.number || 'N/A'}
                </span>
                {viewModalApp.details?.s2?.imageUrl && (
                  <button
                    style={viewButtonStyle}
                    onClick={() =>
                      setImageViewUrl(viewModalApp.details.s2.imageUrl)
                    }
                  >
                    View S2
                  </button>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              >
                ...
                >
                  {viewModalApp.details?.ptr?.number || 'N/A'}
                </span>
                {viewModalApp.details?.ptr?.imageUrl && (
                  <button
                    style={viewButtonStyle}
                    onClick={() =>
                      setImageViewUrl(viewModalApp.details.ptr.imageUrl)
                    }
                  >
                    View PTR
                  </button>
            ...
            >
              ...
              <span style={{ fontSize: '16px', color: '#2c3e50' }}>
                {[
                  viewModalApp.details?.addressLine1,
                  viewModalApp.details?.addressLine2,
                  viewModalApp.details?.barangay,
                  viewModalApp.details?.city,
                  viewModalApp.details?.province,
                  viewModalApp.details?.region,
                  viewModalApp.details?.zipCode,
                ]
                  .filter(Boolean)
                  .join(', ') || 'N/A'}
              </span>
          ...
          <div className='modal-actions'>
            ...
            <button
              ...
              onClick={() =>
                handleAccept(viewModalApp.userId || viewModalApp.id)
              }
            >
              Accept
            </button>
