...
const [searchTerm, setSearchTerm] = useState('');
  ...
  const [pendingApplications, setPendingApplications] = useState([
    {
      id: 'APP001', name: 'Dr. Evelyn Reed', email: 'evelyn.reed@clinic.com', date: '2025-08-20',
      details: {
    ...
    {
      id: 'APP002', name: 'Dr. Samuel Chen', email: 'sam.chen@med.com', date: '2025-08-18',
      details: {
     ...
     {
      id: 'APP003', name: 'Dr. Maria Garcia', email: 'maria.garcia@health.org', date: '2025-08-22',
      details: {
  ...
  const [specialists, setSpecialists] = useState([
    { 
      id: 'SPEC001', firstName: 'John', lastName: 'Doe', email: 'john.doe@okiedoc.com', status: 'Active',
      details: {
    ...
    { 
      id: 'SPEC002', firstName: 'Jane', lastName: 'Smith', email: 'jane.smith@okiedoc.com', status: 'Active',
      details: {
  ...
  const filteredPending = pendingApplications.filter(app => {
    ...
    const matchesFilter = filterSpecialization ? app.details.specializations.includes(filterSpecialization) : true;
  ...
  const filteredSpecialists = specialists.filter(spec => {
    ...
    const matchesSearch = searchString.includes(searchTerm.toLowerCase());
    const matchesFilter = filterSpecialization ? spec.details.specializations.includes(filterSpecialization) : true;
    return matchesSearch && matchesFilter;
  });
  ...
  return (
    <>
      ...
      <main className="dashboard-container">
        ...
        {activeTab === 'list' && (
          <SpecialistTable specialists={filteredSpecialists} onAddSpecialist={handleAddSpecialist} />
        )}
      </main>
    </>
  );
