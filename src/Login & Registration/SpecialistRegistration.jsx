...
export default function SpecialistRegistration() {
  ...
  const handleSubmit = (e) => {
    ...
    const { isValid, errors: validationErrors } = authService.validateSpecialistData({
      ...formData,
      ...
      <div className="login-container">
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <p className="login-text">
            ...
            <a className="specialist-link" href="/specialist-login">Login here</a>
          </p>
          <p className="login-text">
            Not a specialist? <a className="specialist-link" href="/registration">Register as a patient</a>
          </p>
        </form>
      </div>
    </div>
