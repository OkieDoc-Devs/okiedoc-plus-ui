...
export default function SpecialistRegistration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      payload.append("facebookProfileLink", formData.facebookProfileLink || "");
      ...
      payload.append("initialConsultationFee", formData.initialConsultationFee || "");
      payload.append("followUpConsultationFee", formData.followUpConsultationFee || "");
      payload.append("medicalCertificateFee", formData.medicalCertificateFee || "");
      payload.append("seniorDiscount", formData.seniorDiscount || "");
      payload.append("pwdDiscount", formData.pwdDiscount || "");
      payload.append("disbursementMethod", formData.disbursementMethod || "");
      ...
      if (result.success || result.message) {
        ...
        setHmoPartnerships([{ hmoName: "", details: "", billingContact: "" }]);
        setHospitalAffiliations([{ hospitalName: "", address: "" }]);
        setClinicAffiliations([{ clinicName: "", address: "" }]);
    ...
    <>
      {success && (
        ...
        >
          ...
          >
            <div style={{ fontSize: "64px", color: "#2ecc71", marginBottom: "15px" }}>
              <FaCheck />
            </div>
