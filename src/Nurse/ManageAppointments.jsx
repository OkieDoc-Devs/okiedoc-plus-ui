...
import { generatePostConsultationBillingPDF } from "./services/invoiceService.js";
...
import {
  PAIN_MAP_AREAS,
  PAIN_MAP_VIEWS,
} from "../components/PainMap/painMapConstants.js";
...
function NurseCreateTicketWorkspace({
  onBack,
  onTicketCreated,
  ...
  const [formData, setFormData] = useState(() => {
    try {
      ...
      return savedDraft
        ? { ...createEmptyTicketForm(), ...JSON.parse(savedDraft) }
  ...
  const handlePatientSelect = (patient) => {
    setFormData((previous) => ({
      ...
      isUsingHmo:
        patient.hmoCompany || patient.hmoMemberId ? "yes" : previous.isUsingHmo,
    }));
    setPatientResults([]);
  ...
  const handlePainAreaToggle = (area) => {
    ...
    setFormData((previous) => {
      const isSelected = previous.painAreas.some(
            ...
            >
              ...
              {showPatientResults && (
                <div className="create-ticket-patient-menu">
                  {isSearchingPatients ? (
                    <div className="create-ticket-patient-empty">
                      Searching patients...
                    </div>
          ...
          <div className="create-ticket-grid two">
            <div className="create-ticket-field">
              ...
              <CreateTicketSelect
                ...
                placeholder={
                  psgcLoading.regions ? "Loading regions..." : "Select region"
                }
            ...
            <div className="create-ticket-field">
              ...
              <CreateTicketSelect
                ...
                disabled={
                  Boolean(formData.patientId) ||
                  !formData.region ||
                  psgcLoading.provinces
                }
                placeholder={
                  psgcLoading.provinces
                    ? "Loading provinces..."
        ...
        <section className="create-ticket-card">
          ...
          <div className="create-ticket-radio-row">
            ...
            <label>
              <input
                type="radio"
                name="hmo"
                checked={formData.isUsingHmo === "yes"}
                onChange={() => updateField("isUsingHmo", "yes")}
              />{" "}
              Yes
            </label>
            <label>
              <input
                type="radio"
                name="hmo"
                checked={formData.isUsingHmo === "no"}
                onChange={() => updateField("isUsingHmo", "no")}
              />{" "}
              No
            </label>
          </div>
          <div className="create-ticket-field full">
            ...
            <input
              ...
              onChange={(event) =>
                updateField("hmoProvider", event.target.value)
              }
            />
          </div>
          <div className="create-ticket-field full">
        ...
        <section className="create-ticket-card">
          ...
          <div className="create-ticket-field full">
            ...
            <input
              ...
              onChange={(event) =>
                updateField("otherSymptoms", event.target.value)
              }
            />
          </div>
        </section>
          ...
          <article className="triage-pain-map-card">
                ...
                <div className="triage-vitals-grid triage-vitals-grid-readonly inline">
                  <div className="triage-pain-meta-item">
                    ...
                    <div className="triage-vital-input-wrap triage-vital-input-wrap-meta">
                      ...
                      />
                      <div
                        className="create-ticket-number-stepper"
                        aria-label="Pain score controls"
                      >
                        <button
                          type="button"
                          onClick={() =>
                            adjustNumericField("severity", 1, 0, 10)
                          }
                          aria-label="Increase pain score"
                        >
                        ...
                        <button
                          ...
                          aria-label="Decrease pain score"
                        >
                  ...
                  <div className="triage-pain-meta-item triage-pain-meta-item-duration">
                    ...
                    <div className="triage-vital-input-wrap triage-vital-input-wrap-duration triage-vital-input-wrap-meta">
                      ...
                      <div
                        className="create-ticket-number-stepper"
                        aria-label="Pain duration controls"
                      >
                        <button
                          type="button"
                          onClick={() =>
                            adjustNumericField("durationValue", 1, 0)
                          }
                          aria-label="Increase pain duration"
                        >
                          <ChevronUp size={12} strokeWidth={2.5} />
                        </button>
                        <button
                          ...
                          aria-label="Decrease pain duration"
                        >
                          <ChevronDown size={12} strokeWidth={2.5} />
                        </button>
                      </div>
            ...
            <div className="triage-pain-map-content">
              <div className="triage-pain-map-picker">
                <div
                  className={`triage-pain-map-figure ${formData.painMapView === "back" ? "back" : "front"}`}
                >
...
export default function ManageAppointment() {
        ...
        setTickets((prevTickets) => {
          ...
          try {
            ...
            triageDraftsByTicketId =
              parsedDrafts && typeof parsedDrafts === "object"
                ? parsedDrafts
                : {};
          } catch {
            triageDraftsByTicketId = {};
          ...
          const mergedApiTickets = apiTickets.map((apiTicket) => {
            ...
            const draftStatus =
              localDraft.status || localDraft.triageStatus || null;
  ...
  useEffect(() => {
    ...
    apiRequest(`/api/v1/nurse/available-slots?date=${scheduleDate}`)
      .then((res) => {
  ...
  const handleNurseTicketCreated = (createdTicket) => {
    ...
    addNotification(
      "Ticket Created",
      "The consultation ticket was added to the patient queue.",
    );
  };
  ...
  const handleSendToPatient = async (billingPayload) => {
    try {
      ...
      if (response) {
        alert(
          response.message ||
            "Invoice generated and sent to patient successfully!",
        );
      ...
      <div className="dashboard-header">
        ...
        <div className="nurse-header-actions">
          ...
          <div className="user-account">
            <Avatar
              profileImageUrl={
                getNurseProfileImage() !== "/account.svg"
                  ? getNurseProfileImage()
                  : null
              }
              firstName={nurseName}
